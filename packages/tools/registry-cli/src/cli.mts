...
function usage(): string {
  return [
    ...
    "",
    "Builds servers.json from registry/<provider> MCP manifests and server.json documents.",
    "",
...
async function main(): Promise<void> {
  ...
  process.stdout.write(
    `Wrote servers.json and generated registry/index.json with ${artifacts.serversJson.servers.length} MCP entries.\n`,
  );
}
