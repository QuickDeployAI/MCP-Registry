...
export const GENERATED_MCP_FIXTURE_INTENTS: GeneratedMcpManifestIntent[] = [
  {
    ...
    deployment: {
      configSchema: {
        type: "object",
        required: ["baseUrl"],
        properties: { baseUrl: { type: "string", description: "OpenAPI base URL." } },
      },
    },
  },
  {
  ...
  },
  {
    ...
    deployment: {
      configSchema: {
        type: "object",
        required: ["endpoint"],
        properties: { endpoint: { type: "string", description: "gRPC endpoint." } },
      },
    },
  },
  {
