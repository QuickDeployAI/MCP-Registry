...
This package now lives in the MCP-Registry workspace at `packages/importers/feed-2-mcp`. It was previously published as `rss-2-mcp`; the workspace package and CLI are now `@quickdeployai/feed-2-mcp` and `feed-2-mcp`.
