...
This package now lives in the MCP-Registry workspace at `packages/importers/openapi-2-mcp`. The former standalone repository should point here after the first workspace release ships.
